package org.integratedsemantics.flexibleshareair.app
{
	...
	import org.integratedsemantics.flexibleshareair.flexspaces.all.FlexSpacesAirPod;
	import org.integratedsemantics.flexibleshareair.flexspaces.doclib.DocLibPod;
	import org.integratedsemantics.flexibleshareair.flexspaces.search.SearchPod;
	import org.integratedsemantics.flexibleshareair.flexspaces.search.SimpleSearchPod;
	import org.integratedsemantics.flexibleshareair.flexspaces.tasks.TasksPod;
	import org.integratedsemantics.flexibleshareair.flexspaces.wcm.WcmPod;
	
	import org.integratedsemantics.flexibleshareair.share.blog.BlogPod;
	import org.integratedsemantics.flexibleshareair.share.dashboard.ShareHtmlPod;
	import org.integratedsemantics.flexibleshareair.share.discussions.DiscussionsPod;
	import org.integratedsemantics.flexibleshareair.share.doclib.ShareDocLibPod;
	import org.integratedsemantics.flexibleshareair.share.wiki.WikiPod;
	...
	public class FlexibleShareAirAppBase extends AirAppBase
	{
		...
		protected function addPods(manager:PodLayoutManager):void
		{
			...
			for (var j:Number = 0; j < podLen; j++)
			{
				...
				{
					podContent = new FlexSpacesAirPod();						
				}  	
				...
				else if (podXMLList[j].@type == "share")
				{
					podContent = new ShareHtmlPod();						
				}  											
